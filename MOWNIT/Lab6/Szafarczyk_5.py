...
if __name__ == '__main__':
    ...
    print("Testy dla zadanej funkcji:")
    tests()
    ...
    start = np.array([[np.random.uniform(0, 1000)], [np.random.uniform(0, 1000)], [np.random.uniform(-1000, 1000)]],
                     dtype=np.float64)
    print("\nRozwiazanie ukladu dla punktu startowego: (x1:", *start[0], "x2:", *start[1], "x3:", *start[2], ")")
